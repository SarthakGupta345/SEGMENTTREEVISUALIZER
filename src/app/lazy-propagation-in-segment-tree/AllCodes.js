...
int query(int idx, int l, int r, int ql, int qr)
{
    ...
    pointUpdateCode: `// Point update: add val at position pos
void pointUpdate(int idx, int l, int r, int pos, int val)
{
    push(idx, l, r);
    ...
    rangeUpdateCode: `// Range update: add val in [ql, qr]
void rangeUpdate(int idx, int l, int r, int ql, int qr, int val)
{
    push(idx, l, r);
    ...
    lazyPushCode: `// Push lazy value to children
void push(int idx, int l, int r)
{
    if (lazy[idx] == 0)
        return;
